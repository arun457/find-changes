			...
			<div id="invoice" class="tab-pane active">
                                <div id="invoice_print">
                                    <div class="invoice">
                                        <header class="clearfix">
                                            <div class="row">
                                                <div class="col-xs-6">
                                                    <div class="ib">
                                                        <img src="https://www.ramomcoder.com/v4/uploads/app_image/printing-logo.png"
                                                            alt="RamomCoder Img" />
                                                    </div>
                                                </div>
                                                <div class="col-md-6 text-right">
                                                    <h4 class="mt-none mb-none text-dark">Invoice No #0008</h4>
                                                    <p class="mb-none">
                                                        <span class="text-dark">Date : </span>
                                                        <span class="value">26.Oct.2021</span>
                                                    </p>
                                                    <p class="mb-none">
                                                        <span class="text-dark">Status : </span>
                                                        <span class='value label label-danger-custom '>Unpaid</span>
                                                    </p>
                                                </div>
                                            </div>
                                        </header>
                                        <div class="bill-info">
                                            <div class="row">
                                                <div class="col-xs-6">
                                                    <div class="bill-data">
                                                        <p class="h5 mb-xs text-dark text-weight-semibold">Invoice To :
                                                        </p>
                                                        <address>
                                                            abc xyz<br>Class : Eight<br>Email : </address>
                                                    </div>
                                                </div>
                                                <div class="col-xs-6">
                                                    <div class="bill-data text-right">
                                                        <p class="h5 mb-xs text-dark text-weight-semibold">Academic :
                                                        </p>
                                                        <address>
                                                            Icon School & College<br />Chyakunjo, Moylapotha, New
                                                            York<br />+158 2045 0412<br />icon@gmail.com<br />
                                                        </address>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <table class="table invoice-items table-hover mb-none">
                                                <thead>
                                                    <tr class="text-dark">
                                                        ...
                                                        <th id="cell-item" class="text-weight-semibold">Fees Type</th>
                                                        <th id="cell-id" class="text-weight-semibold">Due Date</th>
                                                        <th id="cell-price" class="text-weight-semibold">Status</th>
                                                        <th id="cell-price" class="text-weight-semibold">Amount</th>
                                                        <th id="cell-price" class="text-weight-semibold">Discount</th>
                                                        <th id="cell-price" class="text-weight-semibold">Fine</th>
                                                        <th id="cell-price" class="text-weight-semibold">Paid</th>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td>1</td>
                                                        <td class="text-weight-semibold text-dark">Online exam</td>
                                                        <td>16.Jun.2021</td>
                                                        <td><span class='label label-danger-custom '>Unpaid</span></td>
                                                        <td>$500.00</td>
                                                        <td>$0.00</td>
                                                        <td>$0.00</td>
                                                        <td>$0.00</td>
                                        ...
                                        <div class="invoice-summary text-right mt-lg">
                                            <div class="row">
                                                <div class="col-lg-5 pull-right">
                                                    <ul class="amounts">
                                                        <li><strong>Grand Total :</strong> $500.00</li>
                                                        <li><strong>Paid :</strong> $0.00</li>
                                                        <li><strong>Discount :</strong> $0.00</li>
                                                        <li><strong>Fine :</strong> $0.00</li>
                                                        <li>
                                                            <strong>Balance : </strong>
                                                            $500.00 </br>( Five Hundred )
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                                    ...
                                    <div class="text-right mr-lg hidden-print">
                                        <button onClick="fn_printElem('invoice_print')" class="btn btn-default ml-sm"><i
